...
@section('content')
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" class="bg-[#121214] border border-white/[0.05] p-6 sm:p-8 rounded-2xl shadow-2xl max-w-lg transition-all duration-300 hover:border-amber-400/20 group relative overflow-hidden">
        @csrf
